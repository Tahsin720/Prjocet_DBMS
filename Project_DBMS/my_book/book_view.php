		...
		while($row = mysqli_fetch_array($res)){
			?>
				...
				<tr>
                    ...
                    <td>
                        <button class="btn"> <a class = "rating" href="..\donate\form.php?id=<?php echo $row['id']?>">Edit</a> </button>
                        <button class="btn"> <a class = "rating" href="..\delete\delete.php?id=<?php echo $row['id']; ?>">Delete</a> </button>
                    </td>
				</tr>
