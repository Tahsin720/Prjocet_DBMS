...
if (!isset($_SESSION['user']) &&  empty($_SESSION['user'])) {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
      ...
      $post_book_name = $post['book_name'];
      $post_author_name = $post['book_author'];
      $username = $_SESSION['user'];
              ...
              <div class="card p-3 mt-3">
                <div class="form-group px-2">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control mt-2" id="review-book" name="review-book" rows="1" value="<?php echo $post_book_name; ?>"></input>
                  </div>
                  <div class="form-group mb-3">
                    <label for="review-title mb-2">Author</label>
                    <input type="text" class="form-control mt-2" id="review-author" name="review-author" rows="1" value="<?php echo $post_author_name; ?>"></input>
                  </div>
                  <!-- Rating -->
