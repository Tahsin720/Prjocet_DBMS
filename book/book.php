...
<body>
			...
			?>
				...
				<tr>
					...
					<td>
							...
							<button style = "border-radius: 5px; padding: 3px 5px;" type = "button" onclick="requestfn('<?php echo $row['isbn']; ?>')">Request</button>
	...
	?>
	<script>
		function requestfn(isbn){
			console.log(isbn);
			location.assign('../request/confirm_req.php?isbn='+isbn);
		}
	</script>
</body>
</html>